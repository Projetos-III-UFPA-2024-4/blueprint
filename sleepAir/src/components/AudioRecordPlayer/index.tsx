...
const AudioRecorder = () => {
  ...
  // Estados para o modal de renomeação (declarados apenas uma vez)
  ...
  // Escolhe a pasta e salva no AsyncStorage
  ...
  // Carrega a pasta salva do AsyncStorage
  const loadSelectedDirectory = async () => {
    try {
      ...
      if (storedDir) {
        ...
        // Se não houver pasta salva, força a escolha
  ...
  // Abre o modal com as opções para o áudio selecionado
  const handleAudioPress = (item: string) => {
    setSelectedAudio(item);
    setModalVisible(true);
  };

  // Função para renomear o áudio
          ...
          <View style={modalStyles.modalContent}>
            ...
            <TouchableOpacity
              style={[
                ...
                playing && { backgroundColor: '#e77e28' },
              ]}
